...
from .. import db
from main.models import pedidos_db
...
# GET: Obtener listado de Pedidos. Rol: ADMIN  
    def get(self):
        ...
        pedidos = db.session.query(pedidos_db).all()
...
# POST: Crear un usuario. Rol: ADMIN
    def post(self):
        ...
        pedido = pedidos_db.from_json(request.get_json())
...
# GET: Obtener un pedido. Rol: USER/ADMIN/ENCARGADO
    def get(self, id):
        pedido = db.session.query(pedidos_db).get_or_404(id) 
