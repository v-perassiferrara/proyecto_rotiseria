...
export const routes: Routes = [
    ...
    {path:'admin/detalle-promocion', loadComponent: () => import('./pages/admin/detalle-promocion/detalle-promocion').then(m => m.DetallePromocion), canActivate: [authsessionGuard]},
